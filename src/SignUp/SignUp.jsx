    ...
    return (
        <div className="mt-12 mb-7 lg:flex ">
            ...
            <div className=" relative flex flex-col text-gray-700  bg-white shadow-md w-96 rounded-xl bg-clip-border">
                ...
                <form onSubmit={hadnlerSignUp}>   <div className="flex flex-col gap-4 p-6 mt-2">
                    {/* name */}
                    <div className="relative h-11 w-full min-w-[200px] mb-1">
                        <input
                    ...
                    <div className="p-4 pt-0">
                        ...
                        <h1 className='text-center mt-2'>Or Sign Up with</h1>
